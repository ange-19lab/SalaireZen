							        ...
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
                                             ...
                                             <tr>
												...
												<td class="cell">
                                 <a class="btn-sn app-btn-secondary btn-margin" href="{{route('employer.edit', $employer->id)}}">Editer</a>
                                 <a class="btn-sn app-btn-secondary btn-margin" href="{{route('employer.delete', $employer->id)}}">Retirer</a>
                                                </td>
                                             ...
                                             <tr>
												<td class="cell" colspan="6">Aucun employer ajoutes</td>
